 ...
 */
function createTestBuffer(updateTime: bigint, unitData: ArrayBuffer): ArrayBuffer {
 ...
 */
function encodeUnitWithCategory(unitId: number, category: string): ArrayBuffer {
