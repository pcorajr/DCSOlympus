...
/**
 * Type of data for each DataIndex.
 * Used to determine how many bytes to skip when encountering unknown fields.
 */
export type DataIndexType = "uint8" | "uint16" | "uint32" | "uint64" | "float64" | "bool" | "string" | "latlng" | "tacan" | "radio" | "generalSettings" | "ammo" | "contacts" | "activePath" | "offset" | "drawingArguments";
 ...
 */
export const DATA_INDEX_TYPES: Record<number, DataIndexType> = {
 ...
 */
export function skipDataByType(extractor: { extractUInt8(): number; extractUInt16(): number; extractUInt32(): number; extractUInt64(): bigint; extractFloat64(): number; extractBool(): boolean; extractString(): string; extractLatLng(): any; extractTacan(): any; extractRadio(): any; extractGeneralSettings(): any; extractAmmo(): any[]; extractContacts(): any[]; extractActivePath(): any[]; extractOffset(): any; extractDrawingArguments(): any[]; getSeekPosition(): number }, type: DataIndexType): void {
  switch (type) {
    case "uint8":
